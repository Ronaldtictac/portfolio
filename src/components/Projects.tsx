              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((t) => (
                    <span
                      key={t}
                      className="px-3 py-1 bg-primary/10 text-primary text-xs font-medium rounded-full transition-all duration-300 hover:bg-primary hover:text-white"
                    >
                      {t}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  <Link
                    href={project.demo}
                    target="_blank"
                    className="flex items-center gap-2 text-accent hover:text-primary font-medium text-sm transition-all duration-300 hover:gap-3"
                  >
                  ...
                  <Link
                    href={project.repo}
                    target="_blank"
                    className="flex items-center gap-2 text-gray-600 hover:text-primary font-medium text-sm transition-all duration-300 hover:gap-3"
                  >
